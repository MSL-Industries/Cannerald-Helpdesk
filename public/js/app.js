...
function addListeners() {
    ...
    $(".loadingImage").show(), postSaveOrder(window.location.origin + "/thrust/" + t + "/updateOrder?startAt=" + e, ".sortable");
    ...
    function n(t) {
        ...
        return e ? tt.swap(t, { display: "inline-block" }, _, [t, "marginRight"]) : void 0;
